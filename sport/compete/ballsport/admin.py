...
from sport.compete.ballsport.models import AmericanFootballEvent, BaseballEvent, BasketballEvent, BowlsEvent
from sport.compete.ballsport.models import CricketEvent, CueEvent, DodgeballEvent, FootballEvent
from sport.compete.ballsport.models import RugbyLeagueEvent, RugbyUnionEvent, GolfEvent, HurlingEvent
from sport.compete.ballsport.models import LacrosseEvent, NetballEvent, PoloEvent, SquashEvent, VolleyballEvent
