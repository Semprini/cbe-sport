...
from sport.sport.models import Competition
from sport.compete.models import Team, TeamFixture,IndividualFixture, Fixture, Entry
from sport.compete.models import EventTemplate, PointsEntry
from sport.compete.models import Position, CompetitionRound
